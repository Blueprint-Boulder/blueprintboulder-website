...
import { ProjectCard, ProjectCardContents, ProjectImage, ProjectVideo, ProjectCardName, ProjectMembers } from 'components/common/ProjectCard';
            ...
            <ProjectCard theme={theme}>
              ...
              <ProjectCardContents>
                <Content>
                  ...
                  <h4>{tldr}</h4>
                  <p>{description}</p>
                  <ProjectMembers team_leads={team_leads} members={members}></ProjectMembers>
