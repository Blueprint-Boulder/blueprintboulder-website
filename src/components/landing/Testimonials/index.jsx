...
import { faCode, faPeopleGroup, faMagnifyingGlassChart } from '@fortawesome/free-solid-svg-icons';
...
export default function Testimonials() {
    ...
    return (
        <>
            <div className="carousel" style={{ background: (theme === 'light' ? '#fff' : '#181717') }} theme={theme}>
                <p className="testimonialText" style={{ color: (theme === 'dark' ? '#73b7ff' : '#0078f8') }}>"{slide.text}"</p>
                ...
                <p className="credit" style={{ color: (theme === 'dark' ? '#73b7ff' : '#0078f8') }}>- {slide.credit}</p>
                <FontAwesomeIcon
                    icon={slide.icon}
                    size="4x"
                    className="icon"
            ...
            <div className="slideIndicator">
                <span className="dot" style={{ background: (slideNumber === 1 ? '#aaa' : '#ddd') }}></span>
                <span className="dot" style={{ background: (slideNumber === 2 ? '#aaa' : '#ddd') }}></span>
                <span className="dot" style={{ background: (slideNumber === 3 ? '#aaa' : '#ddd') }}></span>
                <span className="dot" style={{ background: (slideNumber === 4 ? '#aaa' : '#ddd') }}></span>
            </div>
        </>
    );
};
